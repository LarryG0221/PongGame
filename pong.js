...
var Ball = function(position, speed) {
    ...
    this.draw = function() {
        ...
        // eyes
        fill(46, 46, 41);
        ellipse(this.position.x-5, this.position.y-4, 4, 4);
        ellipse(this.position.x+6, this.position.y-4, 4, 4);
        
        // mouth
        fill(252, 65, 65);
        ellipse(this.position.x+2, this.position.y+5, 12, 13.6);
    };
...
var drawScores = function() {
    ...
    s = "Larry: " + player1Score;
    text(s, width*0.25-textWidth(s)/2, 25);
    s = "Computer: " + player2Score;
